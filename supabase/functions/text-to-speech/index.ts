...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Converting text to speech with ElevenLabs (emotionally rich model)...');

    // Use Charlotte voice (warm, professional) with eleven_multilingual_v2 for most natural speech
